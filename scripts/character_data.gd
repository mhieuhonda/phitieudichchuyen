...
## CharacterData - Dữ liệu nhân vật (v3.0)
...
##
## v3.0: Dọn dẹp - đã xóa nhân vật "Hieu Louis - Classic" và "Ma Tôn",
##        xóa hoàn toàn hệ thống mã quà tặng (gift codes) và feature unlocks.
##        Chỉ còn 12 nhân vật thường, tất cả đều mở khóa sẵn.
...
## v3.0: Tất cả nhân vật đều mở khóa sẵn (đã xóa hệ thống gift code)
func is_unlocked(id: int) -> bool:
        return true

## v3.0: Stub giữ lại để tương thích ngược với code cũ (không còn tác dụng)
