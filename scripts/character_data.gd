...
## CharacterData - Dữ liệu nhân vật (v2.1)
...
# v2.1: Mã quà tặng hợp lệ
const GIFT_CODES: Dictionary = {
	"hieulouis99": 12,  # Mở khóa Hieu Louis - Classic
}
