...
## AIPlayer - NPC đối thủ (v3.3) - Smarter AI
...
## - AI uses skills occasionally (dash để né/truy đuổi)
...
func _ai_dash(dir: Vector2):
	...
	dash_cooldown = GameManager.skill_dash_cooldown * 1.4  # AI dash lâu hơn player
