...
## UICustomization - Chỉnh sửa giao diện (v1.3)
...
# Note: we use only _input (not _gui_input) to avoid double-handling events
# that fall inside the preview area. _input catches both inside and outside drags.
