...
"""
Phi Tiêu Dịch Chuyển — Server v4.1
...
<head>
<meta charset="utf-8">
<title>Phi Tiêu Dịch Chuyển — Server v4.1</title>
<style>
...
<body>
<div class="container">
    <h1>🎯 Phi Tiêu Dịch Chuyển — Server v4.1</h1>
    <div class="subtitle">Multiplayer + Auth + Profile + Leaderboard</div>
    <p>Server backend cho game <b>Phi Tiêu Dịch Chuyển v4.1</b>. Bao gồm:</p>
    <ul>
    ...
    <div class="footer">
        Phi Tiêu Dịch Chuyển v4.1 — by mhieuhonda<br>
...
def main():
    log.info("=" * 60)
    log.info("Phi Tiêu Dịch Chuyển — Server v4.1")
